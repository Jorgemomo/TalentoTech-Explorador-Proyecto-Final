...
async function cargarPerfil() {
  setLoading(true);
  try {
    const res = await fetch(`${API_URL}/perfil?email=${encodeURIComponent(sesion.email)}`);
    ...
    document.getElementById("statTelefono").textContent = usuario.telefono || "—";
    document.getElementById("statUbicacion").textContent = usuario.ubicacion || "—";
...
document.getElementById("formDatos").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    document.getElementById("statTelefono").textContent = payload.telefono || "—";
    document.getElementById("statUbicacion").textContent = payload.ubicacion || "—";
